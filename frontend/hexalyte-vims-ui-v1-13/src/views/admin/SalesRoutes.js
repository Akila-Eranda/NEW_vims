                  ...
                  <div className="p-5">
                    ...
                    <div className="flex gap-2 mt-4 pt-3 border-t border-gray-50">
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 py-1.5 rounded-lg text-sm font-medium transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 bg-red-50 hover:bg-red-100 text-red-600 py-1.5 rounded-lg text-sm font-medium transition-colors"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
